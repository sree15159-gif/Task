...
const ShopListBannerRightSidebar = () => {
  return (
          ...
          <div className="col-12">
            <div className="row gi_breadcrumb_inner">
              <div className="col-md-6 col-sm-12">
                <h2 className="mn-breadcrumb-title">Shop List Banner Right Sidebar</h2>
              </div>
              <div className="col-md-6 col-sm-12">
          ...
          <div className="row">
            <div className="col-lg-9 col-md-12">
              <div className="mn-shop-content">
                <h3>Shop List Banner Right Sidebar Page</h3>
                <p>This is the shop page with list view, banner and right sidebar layout.</p>
...
export default ShopListBannerRightSidebar;