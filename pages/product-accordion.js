          ...
          <div className="mn-pro-rightside mn-common-rightside col-lg-9 col-md-12 m-b-15">
            ...
            <div className="mn-accordion style-1 mn-single-pro-tab-content">
              <div className="mn-accordion-item">
                <h4 className="mn-accordion-header">Product Detail</h4>
              ...
              <div className="mn-accordion-item">
                <h4 className="mn-accordion-header">Specifications</h4>
              ...
              <div className="mn-accordion-item">
                <h4 className="mn-accordion-header">Vendor</h4>
                <div className="mn-accordion-body">
                  <div className="mn-single-pro-tab-moreinfo">
                    <div className="mn-product-vendor">
                      <div className="mn-vendor-info mt-2">
                        <span>
