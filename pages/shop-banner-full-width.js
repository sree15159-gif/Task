        ...
        <div className="row">
          ...
          <div className="mn-shop-rightside col-md-12 m-t-991">
            ...
            <div className="mn-pro-list-top d-flex">
              <div className="col-md-6 mn-grid-list">
                <div className="mn-gl-btn">
                  ...
                  <button className="grid-btn btn-grid-50">
                    <i className="ri-gallery-view-2" />
                  </button>
                  <button className="grid-btn btn-list-50 active">
            ...
            <div className="shop-pro-content">
              <div className="shop-pro-inner list-view-50">
                <div className="row">
                  <div className="col-lg-3 col-md-4 col-sm-6 col-12 m-b-24 mn-product-box pro-gl-content width-50">
