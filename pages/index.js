			...
			<div className="row">
				<div className="col-xxl-12">
						...
						<div className="mn-hero-slider owl-carousel">
							<div className="mn-hero-slide swiper-slide slide-1">
								<div className="mn-hero-detail">
									<p className="label"><span>50%  Off</span></p>
									<h1>Fashion sale  for women's</h1>
									<p>Elevate your every day. Style that speaks volumes.</p>
									<a href="#" className="mn-btn-2" onClick={(e) => e.preventDefault()}><span>Shop Now</span></a>
								</div>
							</div>
							<div className="mn-hero-slide swiper-slide slide-2">
								<div className="mn-hero-detail">
									<p className="label"><span>35%  Off</span></p>
									<h2>Fashion sale   for Men's</h2>
									<p>Wear the change. Fashion that feels good.</p>
									<a href="#" className="mn-btn-2" onClick={(e) => e.preventDefault()}><span>Shop Now</span></a>
								</div>
							</div>
							<div className="mn-hero-slide swiper-slide slide-3">
								<div className="mn-hero-detail">
									<p className="label"><span>44%  Off</span></p>
									<h2>Fashion sale  for Children's</h2>
									<p>Wear the change. Fashion that feels good.</p>
									<a href="#" className="mn-btn-2" onClick={(e) => e.preventDefault()}><span>Shop Now</span></a>
								</div>
							</div>
							<div className="mn-hero-slide swiper-slide slide-4">
								<div className="mn-hero-detail">
									<p className="label"><span>22%Off</span></p>
									<h2>Cosmetics sale for Women's</h2>
									<p>Wear the change. Fashion that feels good.</p>
									<a href="#" className="mn-btn-2" onClick={(e) => e.preventDefault()}><span>Shop Now</span></a>
								</div>
							</div>
					...
					<section className="mn-new-product p-tb-15">
						...
						<div className="mn-product owl-carousel">
					...
					<section className="mn-service p-tb-15">
						<div className="row m-b-m-24">
							<div className="mn-ser-content mn-ser-content-1 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
							...
							<div className="mn-ser-content mn-ser-content-2 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
							...
							<div className="mn-ser-content mn-ser-content-3 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
							...
							<div className="mn-ser-content mn-ser-content-4 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
					...
					<section className="mn-banner p-tb-15">
						<div className="row">
							<div className="col-12" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
								<div className="mn-modern-banner owl-carousel">
									<div className="modern-banner">
										<div className="mn-banner-img img-1"></div>
										<div className="mn-banner-contact banner-animation">
											...
											<div className="banner-btn">
												<a href="room-details.html" className="mn-btn-1"><span>Book
														Now</span></a>
											</div>
										</div>
									</div>
									<div className="modern-banner">
										<div className="mn-banner-img img-2"></div>
										<div className="mn-banner-contact banner-animation">
											<div className="inner-banner">
												<h3>WOMEN'S</h3>
					...
					<section className="mn-new-product p-tb-15">
						<div className="mn-title mn-title-2">
							<div className="mn-timer">
								...
								<div className="timer1 timer dealend-timer" data-date="September 30, 2026 19:15:10 PDT">
								</div>
							</div>
						</div>
						<div className="mn-product owl-carousel">
									...
									<div className="mn-test-outer mn-testimonials">
										<ul className="mn-testimonial-slider owl-carousel">
											<li className="mn-test-item">
												<img src="assets/img/icons/top-quotes.svg" className="svg_img test_svg top"
													alt="user">
												<div className="mn-test-inner">
													...
													<div className="mn-test-content">
														<div className="mn-test-desc">Lorem Ipsum is simply dummy text of
											...
											<li className="mn-test-item ">
												...
												<div className="mn-test-inner">
													...
													<div className="mn-test-content">
														<div className="mn-test-desc">Standard dummy text ever since the
											...
											<li className="mn-test-item">
												...
												<div className="mn-test-inner">
													...
													<div className="mn-test-content">
														<div className="mn-test-desc">When an unknown printer took a galley
					...
					<section className="mn-blog p-tb-15">
						...
						<div className="mn-blog-carousel owl-carousel">
							<div className="mn-blog-card">
								<div className="blog-info">
									<figure className="blog-img"><a href="#"><img src="assets/img/blog/1.jpg"
												alt="news imag"/></a>
									</figure>
							...
							<div className="mn-blog-card">
								<div className="blog-info">
									<figure className="blog-img"><a href="#"><img src="assets/img/blog/2.jpg"
												alt="news imag"/></a>
									</figure>
									<div className="detail">
							...
							<div className="mn-blog-card">
								<div className="blog-info">
									<figure className="blog-img"><a href="#"><img src="assets/img/blog/3.jpg"
												alt="news imag"/></a>
									</figure>
									<div className="detail">
							...
							<div className="mn-blog-card">
								<div className="blog-info">
									<figure className="blog-img"><a href="#"><img src="assets/img/blog/4.jpg"
												alt="news imag"/></a>
									</figure>
									<div className="detail">
							...
							<div className="mn-blog-card">
								<div className="blog-info">
									<figure className="blog-img"><a href="#"><img src="assets/img/blog/5.jpg"
												alt="news imag"/></a>
									</figure>
									<div className="detail">
							...
							<div className="mn-blog-card">
								<div className="blog-info">
									<figure className="blog-img"><a href="#"><img src="assets/img/blog/6.jpg"
												alt="news imag"/></a>
									</figure>
									<div className="detail">
								...
								<div className="insta-auto">
									...
									<div className="mn-insta-item">
										<div className="mn-insta-inner">
											<a href="#" target="_blank"><img src="assets/img/instagram/1.jpg"
													alt="insta"/></a>
										</div>
									</div>
									{/* <!-- instagram item --> */}
									<div className="mn-insta-item">
										<div className="mn-insta-inner">
											<a href="#" target="_blank"><img src="assets/img/instagram/2.jpg"
													alt="insta"/></a>
										</div>
									</div>
									{/* <!-- instagram item --> */}
									<div className="mn-insta-item">
										<div className="mn-insta-inner">
											<a href="#" target="_blank"><img src="assets/img/instagram/3.jpg"
													alt="insta"/></a>
										</div>
									</div>
									{/* <!-- instagram item --> */}
									<div className="mn-insta-item">
										<div className="mn-insta-inner">
											<a href="#" target="_blank"><img src="assets/img/instagram/4.jpg"
													alt="insta"/></a>
										</div>
									</div>
									{/* <!-- instagram item -5 --> */}
									...
									<div className="mn-insta-item">
										<div className="mn-insta-inner">
											<a href="#" target="_blank"><img src="assets/img/instagram/5.jpg"
													alt="insta"/></a>
										</div>
									</div>
									{/* <!-- instagram item -6 --> */}
									...
									<div className="mn-insta-item">
										<div className="mn-insta-inner">
											<a href="#" target="_blank"><img src="assets/img/instagram/6.jpg"
													alt="insta"/></a>
										</div>
									</div>
									{/* <!-- instagram item -7 --> */}
									...
									<div className="mn-insta-item">
										<div className="mn-insta-inner">
											<a href="#" target="_blank"><img src="assets/img/instagram/7.jpg"
													alt="insta"/></a>
										</div>
									</div>
									{/* <!-- instagram item --> */}
