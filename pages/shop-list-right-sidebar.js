        ...
        <div className="row">
          <div className="mn-shop-rightside col-lg-9 col-md-12">
            ...
            <div className="mn-pro-list-top d-flex">
              <div className="col-md-6 mn-grid-list">
                <div className="mn-gl-btn">
                  <button className="grid-btn btn-grid">
                    <i className="ri-gallery-view-2" />
                  </button>
                  <button className="grid-btn btn-list active">
            ...
            <div className="shop-pro-content">
              <div className="shop-pro-inner list-view">
                <div className="row">
                  <div className="col-md-4 col-sm-6 col-xs-6 m-b-24 mn-product-box pro-gl-content width-100">
