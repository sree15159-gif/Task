        ...
        <div className="mn-main-content">
          <div className="row">
					...
					<div className="col-12">
						<div className="row gi_breadcrumb_inner">
							<div className="col-md-6 col-sm-12">
								<h2 className="mn-breadcrumb-title">About us Page</h2>
							</div>
							<div className="col-md-6 col-sm-12">
				...
				<div className="row">
					<div className="col-lg-6 col-md-12">
						<div className="mn-about-img">
							<img src="assets/img/common/about-1.png" className="v-img" alt="about"/>
							<img src="assets/img/common/about-2.png" className="h-img" alt="about"/>
							<img src="assets/img/common/about-3.png" className="h-img" alt="about"/>
							<img src="assets/img/common/about-4.png" className="h-img" alt="about"/>
						</div>
					</div>
					<div className="col-lg-6 col-md-12">
						<div className="mn-about-detail">
							<div className="section-title m-t-991">
								...
								<p>We're here to serve only the best products for you. Enriching your homes with
									the best
									essentials.</p>
							</div>
							...
							<p>Lorem Ipsum has survived not only five centuries, but also the leap into
								electronic
					...
					<div className="mn-ser-content mn-ser-content-3 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
						...
						<div className="mn-ser-box">
							<div className="mn-ser-inner">
								<div className="mn-service-image">
									<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0"
										y="0" viewBox="0 0 512 511" style={{enableBackground:"new 0 0 512 512"}}
										xmlSpace="preserve" className="">
										<g>
											<path
					...
					<div className="mn-ser-content mn-ser-content-4 col-sm-6 col-xl-3 m-b-24" data-aos="fade-up"
						...
						<div className="mn-ser-box">
							<div className="mn-ser-inner">
								<div className="mn-service-image">
									<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0"
										y="0" viewBox="0 0 511 512" style={{enableBackground:"new 0 0 512 512"}}
										xmlSpace="preserve">
										<g>
											<path
							...
							<div className="mn-test-outer mn-testimonials">
								<ul className="mn-testimonial-slider owl-carousel">
									<li className="mn-test-item">
										...
										<img src="assets/img/icons/bottom-quotes.svg" className="svg_img test_svg bottom"
											alt=""/>
									</li>
									<li className="mn-test-item ">
										<img src="assets/img/icons/top-quotes.svg" className="svg_img test_svg top" alt=""/>
										<div className="mn-test-inner">
											<div className="mn-test-img">
			...
			<section className="mn-team-section p-tb-15">
				...
				<div className="mn-team owl-carousel">
