    ...
    <div className="row">
      <div className="col-lg-6 col-md-12">
        <div className="mn-about-img">
          <img
            src="assets/img/common/about-1.png"
            className="v-img"
            alt="about"
          />
          <img
          ...
          />
          <img
            src="assets/img/common/about-4.png"
            className="h-img"
            alt="about"
          />
        </div>
    ...
    <div className="row">
      <div className="col-md-12">
        <div className="testim-bg">
          ...
          <div className="mn-test-outer mn-testimonials">
            <ul className="mn-testimonial-slider owl-carousel">
              <li className="mn-test-item">
                <img
                  src="assets/img/icons/top-quotes.svg"
                ...
                <img
                  src="assets/img/icons/bottom-quotes.svg"
                ...
                <div className="mn-test-inner">
                  ...
                  <div className="mn-test-content">
                    <div className="mn-test-desc">
                      ...
                      printer took a galley of type and this is the lorem and
                ...
                <div className="mn-test-inner">
                  ...
                  <div className="mn-test-content">
                    <div className="mn-test-desc">
                      ...
                      scrambled it to make a type specimen Lorem Ipsum has been
                      the industry's and ever since to the 1500s,{" "}
                    </div>
          ...
          <span className="mn-testi-shape-2" />
        </div>
      </div>
    </div>
  </section>
