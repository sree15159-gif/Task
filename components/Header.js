					...
					<div className="right-header">
						...
						<div className="mn-tool-icons">
							...
							<div className="mn-tool-wish">
								<a href="#" onClick={(e) => e.preventDefault()} className="mn-main-wishlist mn-wishlist-toggle">
							...
							<div className="mn-tool-cart">
								<a href="#" onClick={(e) => e.preventDefault()} className="mn-main-cart mn-cart-toggle">
