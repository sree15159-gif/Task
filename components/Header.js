...
const Header = () => {
  ...
  return (
          ...
          <ul className="mn-sb-list">
            ...
            <li className="mn-sb-item sb-drop-item">
              ...
              <ul className="mn-sb-drop">
                ...
                <li className="list">
                  <Link href="/shop-right-sidebar" className="mn-page-link drop">Sarees</Link>
                </li>
                <li className="list">
			...
			<div className="mn-header">
				<div className="mn-header-items">
					<div className="left-header">
						<a href="#" onClick={(e) => e.preventDefault()} className="mn-toggle-sidebar">
					...
					<div className="right-header">
										...
										<div className="mn-main-menu">
											<ul>
												...
												<li className="dropdown drop-list">
													<a href="#" onClick={(e) => e.preventDefault()} className="dropdown-arrow">Categories<i
															className="ri-arrow-down-s-line"></i></a>
													<ul className="mega-menu d-block">
														<li className="d-flex">
															<span className="bg"></span>
															<ul className="d-block mega-block">
																<li className="menu_title"><a
																		href="#" onClick={(e) => e.preventDefault()}>Classic</a></li>
																<li><Link href="/shop-right-sidebar">Shop Right
																		sidebar</Link></li>
																<li><Link href="/shop-banner-right-sidebar">Banner
																		Right sidebar</Link></li>
																<li><Link href="/shop-full-width">Shop Full
																		Width</Link></li>
																<li><Link href="/shop-banner-full-width">Banner Full
																		Width</Link></li>
															</ul>
															<ul className="d-block mega-block">
																<li className="menu_title"><a
																		href="#" onClick={(e) => e.preventDefault()}>List</a></li>
																<li><Link href="/shop-list-right-sidebar">Shop Right
																		sidebar</Link></li>
																<li><Link href="/shop-list-banner-right-sidebar">Banner
																		Right sidebar</Link></li>
																<li><Link href="/shop-list-full-width">Shop
																		Full Width</Link></li>
																<li><Link href="/shop-list-banner-full-width">Banner
																		Full Width</Link></li>
															</ul>
														</li>
													</ul>
												...
												<li className="dropdown drop-list">
													<a href="#" onClick={(e) => e.preventDefault()} className="dropdown-arrow">Products<i
															className="ri-arrow-down-s-line"></i></a>
													<ul className="sub-menu">
														<li><Link href="/product-detail">product detail</Link></li>
														<li><Link href="/product-accordion">Product accordion</Link></li>
														<li><Link href="/product-full-width">Product full width</Link>
														</li>
														<li><Link href="/product-accordion-full-width">accordion full
																width</Link></li>
													</ul>
												</li>
												<li className="dropdown drop-list">
													<a href="#" onClick={(e) => e.preventDefault()} className="dropdown-arrow">Pages<i
															className="ri-arrow-down-s-line"></i></a>
													<ul className="sub-menu">
														{/* <li className="dropdown position-static">
															<a href="#" onClick={(e) => e.preventDefault()} className="mn-sub-drop">Blog
																<i className="ri-arrow-down-s-line"></i></a>
															<ul className="sub-menu sub-menu-child">
																<li><Link href="/blog-right-sidebar">right sidebar</Link>
																</li>
																<li><Link href="/blog-full-width">Full Width</Link></li>
																<li><Link href="/blog-detail-right-sidebar">Detail
																		right sidebar</Link></li>
																<li><Link href="/blog-detail-full-width">Detail Full
																		Width</Link></li>
															</ul>
														</li> */}
						...
						<div id="mn-mobile-menu" className="mn-mobile-menu">
							<div className="mn-menu-title">
								...
								<button type="button" className="mn-close-menu">×</button>
							</div>
								...
								<div className="mn-menu-content">
									<ul>
										...
										<li>
											...
											<ul className="sub-menu">
												<li>
													<a href="#" onClick={(e) => e.preventDefault()}>Classic</a>
													<ul className="sub-menu">
														<li><Link href="/shop-right-sidebar">Shop Right
																sidebar</Link></li>
														<li><Link href="/shop-banner-right-sidebar">Banner
												...
												<li>
													<a href="#" onClick={(e) => e.preventDefault()}>List</a>
													<ul className="sub-menu">
														<li><Link href="/shop-list-right-sidebar">Shop Right
																sidebar</Link></li>
														<li><Link href="/shop-list-banner-right-sidebar">Banner
										...
										<li>
											...
											<ul className="sub-menu">
												...
												<li><Link href="/product-accordion-full-width">accordion full width</Link>
												</li>
											</ul>
										</li>
										<li>
										...
										<li>
											...
											<ul className="sub-menu">
												<li><Link href="/blog-right-sidebar">Right Sidebar</Link></li>
												<li><Link href="/blog-full-width">Full Width</Link></li>
												<li><Link href="/blog-detail-right-sidebar">Detail Right Sidebar</Link>
												</li>
												<li><Link href="/blog-detail-full-width">Detail Full Width</Link></li>
											</ul>
										</li>
									</ul>
								</div>
						...
						<div className="mn-tool-icons">
							<div className="mn-tool-search">
								<a href="#" onClick={(e) => e.preventDefault()} className="mn-main-search mn-search-toggle">
									<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="20" height="20" x="0"
										y="0" viewBox="0 0 612.01 612.01" style={{enableBackground:"new 0 0 512 512"}}
										xmlSpace="preserve">
										<g>
											<path
							...
							<div className="mn-tool-user">
								<a href="#" onClick={(e) => e.preventDefault()} className="mn-main-user">
									<svg className="svg-icon" width="20" height="20" viewBox="0 0 1024 1024" version="1.1"
							...
							<div className="mn-tool-wish">
								<Link href="/wishlist" className="mn-main-wishlist mn-wishlist-toggle">
									<span className="label lbl-1">{getWishlistItemsCount()}</span>
									<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="20" height="20" x="0"
										y="0" viewBox="0 0 512 512" style={{enableBackground:"new 0 0 512 512"}}
										xmlSpace="preserve">
										<g>
											<path
    ...
    <a className="mn-main-cart mn-cart-toggle">
      <span className="label lbl-2">{getCartItemsCount()}</span>
      <svg
        className="svg-icon"
        width="20"
        height="20"
